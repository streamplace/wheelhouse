...
import EnvironmentVariablesDisplay from "./components/environment-variables/EnvironmentVariablesDisplay";
    ...
    <Provider store={store}>
      <Router>
        <div>
          ...
          <Route path='/environment-variables' component={EnvironmentVariablesDisplay} />
        </div>
      </Router>
    </Provider>
  );
